...
public class P190_StringToArrayOfType {
    ...
    public static void main(String[] args) {
        ...
        // [1.0, 4.0, 5.0, 4.5, 6.0, 5.6, 50000.0, 345.0, 4.0, 5.5, 6.7, 8.0, 30.0,
        // -11199.0, 55.0]
        ...
        System.out.println();
        // [1.0, 4.0, 5.0, 0.5, 0.5, 4.5, 6.0, 5.6, 50000.0, 345.0, 4.0, 63.0, 21.1,
