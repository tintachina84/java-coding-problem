...
public class P211_IntroCheckVirtualThread {

    private static final Logger logger = Logger.getLogger(P211_IntroCheckVirtualThread.class.getName());
    ...
    public static void main(String[] args) {
        ...
        // vThread.setDaemon(false); // java.lang.IllegalArgumentException: 'false' not
        // legal for virtual threads
